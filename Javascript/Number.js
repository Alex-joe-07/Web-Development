    ...
    // console.log("----------------------------------Number to string og cant change ---------------------------");
...
// console.log(value);
    ...
    // console.log("----------------------------------tolocalstring method is used to number into readable format like comma 1,00,000 like this  bydefault in US standards OG cant change---------------------------");
    // let amount = 1000000
